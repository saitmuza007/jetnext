...
const Register=()=>{
    ...
    useEffect(()=>{
        if (typeof window !== 'undefined') {
            ...
            fetch("https://jetapi-production.up.railway.app/api/getAllFiles",{
                method: "GET",
  ...
  <link href="assets/css/style.css" rel="stylesheet" />
      ...
      <div className='container'>
        ...
        <br></br>
      {error==="Unauthenticated , Kindly Login" ?<div  style={{textAlign:"center",marginTop:"150px"}} className="w3-display-middle">
